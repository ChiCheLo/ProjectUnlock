  ...
  <header class="header">
    <div class="header-content">
      ...
      <div class="header-right">
        ...
        <!-- 音量按鈕 -->
        <button class="notif-btn" :title="isMuted ? '已靜音（點擊開啟）' : '音效開啟（點擊靜音）'" @click="toggleMute">
          <!-- 有聲：select_to_speak -->
          <svg v-if="!isMuted" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M14 18.6746V20.7246C16.0667 20.2579 17.75 19.2121 19.05 17.5871C20.35 15.9621 21 14.0913 21 11.9746C21 9.85794 20.35 7.98711 19.05 6.36211C17.75 4.73711 16.0667 3.69128 14 3.22461V5.27461C15.5 5.70794 16.7083 6.54128 17.625 7.77461C18.5417 9.00794 19 10.4079 19 11.9746C19 13.5413 18.5417 14.9413 17.625 16.1746C16.7083 17.4079 15.5 18.2413 14 18.6746Z" fill="#333333"/>
            <path d="M7 14.9996L12 19.9996V3.99961L7 8.99961H3V14.9996H7Z" fill="#333333"/>
            <path d="M14 7.94961V15.9996C14.7833 15.6329 15.3958 15.0871 15.8375 14.3621C16.2792 13.6371 16.5 12.8496 16.5 11.9996C16.5 11.1329 16.2792 10.3329 15.8375 9.59961C15.3958 8.86628 14.7833 8.31628 14 7.94961Z" fill="#333333"/>
          </svg>
          <!-- 靜音：volume_off -->
          <svg v-else xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#333333">
...
import { isMuted, toggleMute } from '../composables/useAudioStore'
